...
export function HeroSection() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center overflow-hidden above-fold">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              />
              <div className="inline-flex items-center gap-2 bg-gold/25 backdrop-blur-sm rounded-full px-5 py-2.5 border border-gold/40">
                <motion.div

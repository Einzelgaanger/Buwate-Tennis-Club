    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          ...
          "50%": { boxShadow: "0 0 35px -5px hsl(var(--gold) / 0.6)" },
        },
      },
      animation: {
      ...
      backgroundImage: {
        ...
        'hero-pattern': 'linear-gradient(165deg, hsl(158 55% 18%) 0%, hsl(165 45% 22%) 35%, hsl(158 50% 20%) 100%)',
        'gold-gradient': 'linear-gradient(135deg, hsl(42 85% 55%) 0%, hsl(38 80% 50%) 100%)',
        'clay-gradient': 'linear-gradient(180deg, hsl(16 75% 48%) 0%, hsl(22 70% 42%) 100%)',
      },
    },
  },
